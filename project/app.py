...
DO_SIMULATE = True        # set to True to simulate the response (skip the open ai API call)
LOG_RESPONSE = False     # set to True to store the prompt, output and response object
